export const HeroSection = () => {
    return <div className="flex flex-col items-center justify-center text-center py-5">
        <div className="border rounded-2xl text-[#464646] w-fit py-1 px-4 mt-3 mb-6">
            Beta Product
        </div>
            <div className="md:text-6xl text-3xl md:px-25 px-5 text-center font-roboto-slab font-medium flex-col items-center">
